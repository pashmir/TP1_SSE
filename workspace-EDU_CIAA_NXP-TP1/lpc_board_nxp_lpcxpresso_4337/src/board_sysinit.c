...
STATIC const PINMUX_GRP_T pinmuxing[] = {
	...
	{0x2,  0, (SCU_MODE_INBUFF_EN | SCU_MODE_PULLUP | SCU_MODE_FUNC4)},	/* LEDR P2_0 FUNC4 => GPIO5[0] */
	{0x2,  1, (SCU_MODE_INBUFF_EN | SCU_MODE_PULLUP | SCU_MODE_FUNC4)},	/* LEDG P2_1 FUNC4 => GPIO5[1] */
	{0x2,  2, (SCU_MODE_INBUFF_EN | SCU_MODE_PULLUP | SCU_MODE_FUNC4)},	/* LEDB P2_2 FUNC4 => GPIO5[2] */
	{0x2, 10, (SCU_MODE_INBUFF_EN | SCU_MODE_PULLUP | SCU_MODE_FUNC0)},	/* LED1 P2_10 FUNC0 => GPIO0[14] */
	{0x2, 11, (SCU_MODE_INBUFF_EN | SCU_MODE_PULLUP | SCU_MODE_FUNC0)},	/* LED2 P2_11 FUNC0 => GPIO1[11] */
	{0x2, 12, (SCU_MODE_INBUFF_EN | SCU_MODE_PULLUP | SCU_MODE_FUNC0)},	/* LED3 P2_12 FUNC0 => GPIO1[12] */
	{0x1, 0, (SCU_MODE_PULLUP | SCU_MODE_INBUFF_EN | SCU_MODE_ZIF_DIS | SCU_MODE_FUNC0)},	/* TEC1 P1_0 FUNC0 => GPIO0[4] */
	{0x1, 1, (SCU_MODE_PULLUP | SCU_MODE_INBUFF_EN | SCU_MODE_ZIF_DIS | SCU_MODE_FUNC0)},	/* TEC2 P1_1 FUNC0 => GPIO0[8] */
	{0x1, 2, (SCU_MODE_PULLUP | SCU_MODE_INBUFF_EN | SCU_MODE_ZIF_DIS | SCU_MODE_FUNC0)},	/* TEC3 P1_2 FUNC0 => GPIO0[9] */
	{0x1, 6, (SCU_MODE_PULLUP | SCU_MODE_INBUFF_EN | SCU_MODE_ZIF_DIS | SCU_MODE_FUNC0)},	/* TEC4 P1_6 FUNC1 => GPIO0[9] */
#endif
